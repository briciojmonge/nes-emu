...
lazy_static!{
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
        ...
        /*Branching */
        OpCode::new(0x4c, "JMP", 3, 3, AddressingMode::NoneAddressing), //Addressing that acts as immidiate
        ...
        OpCode::new(0xd0, "BNE", 2, 2, AddressingMode::NoneAddressing), //+1 if branch occurs, +2 if to a new page
        OpCode::new(0x70, "BVS", 2, 2, AddressingMode::NoneAddressing), //+1 if branch occurs, +2 if to a new page
        OpCode::new(0x50, "BVC", 2, 2, AddressingMode::NoneAddressing), //+1 if branch occurs, +2 if to a new page
        OpCode::new(0x30, "BMI", 2, 2, AddressingMode::NoneAddressing), //+1 if branch occurs, +2 if to a new page
        OpCode::new(0xf0, "BEQ", 2, 2, AddressingMode::NoneAddressing), //+1 if branch occurs, +2 if to a new page
        OpCode::new(0xb0, "BCS", 2, 2, AddressingMode::NoneAddressing), //+1 if branch occurs, +2 if to a new page
        OpCode::new(0x90, "BCC", 2, 2, AddressingMode::NoneAddressing), //+1 if branch occurs, +2 if to a new page
        OpCode::new(0x10, "BPL", 2, 2, AddressingMode::NoneAddressing), //+1 if branch occurs, +2 if to a new page
